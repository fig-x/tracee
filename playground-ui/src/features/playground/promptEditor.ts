...
export const GUIDED_TEMPLATE_COMPONENT_ORDER: PromptComponentType[] = [
  'role',
  'task',
  'goal',
  'inputs',
...
const GUIDED_TEMPLATE_COMPONENT_ORDER_INDEX = GUIDED_TEMPLATE_COMPONENT_ORDER.reduce<Record<PromptComponentType, number>>(
  (acc, type, index) => {
    acc[type] = index;
    return acc;
  },
  {
    role: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    goal: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    constraints: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    task: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    io_rules: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    inputs: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    outputs: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    examples: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    safety: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    tool_instructions: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    external_information: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
    custom: GUIDED_TEMPLATE_COMPONENT_ORDER.length,
  }
);
...
export function getGuidedTemplateComponentOrder(type: PromptComponentType): number {
  return GUIDED_TEMPLATE_COMPONENT_ORDER_INDEX[type];
}
